...
public class LibrettoController {
    ...
    void handleCerca(ActionEvent event) {
    	...
    	Esame e=model.trovaEsame(codice); //Mi ritorna codice esame o null
    	if(e==null){
    ...
    void handleInserisci(ActionEvent event) {
    	...
    	//chiedi al Model di effettuare l'operazione (Non voglio creare il Model nel controllore, ma bensì nel Main)
